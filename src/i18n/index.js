...
export const translations = {
  'zh-CN': {
    ...
    enableMultiPort: '启用多端口监听（仅 Clash Meta / Mihomo）',
    multiPortBasePort: '起始端口',
    multiPortCount: '端口数量',
    missingInput: '缺少输入参数',
    ...
    settingsLockedHint: '输入密码后可调整以下选项。未解锁时，转换使用默认通用设置。',
    settingsPassword: '访问密码',
    settingsUnlock: '解锁设置',
    settingsUnlocked: '已解锁',
    settingsLock: '重新锁定',
    settingsWrongPassword: '密码不正确，请重试。',
    settingsTooManyAttempts: '尝试次数过多，请一分钟后重试。',
    settingsRequestFailed: '操作失败，请检查网络后重试。',
    settingsSessionExpired: '解锁已过期，请重新输入密码。',
    settingsLinkOnCopy: '点击复制，生成包含当前设置的可用链接。',
    groupByCountry: '按国家分组',
    groupByCountryTip: '仅 Clash/Surge/SingBox 生效',
    includeAutoSelect: '包含自动选择分组',
    excludeInvalidNodes: '排除无效节点',
    excludeInvalidNodesTip: '过滤机场的官网/到期/流量/套餐等信息节点',
  ...
  'en-US': {
    ...
    enableMultiPort: 'Enable multi-port listeners (Clash Meta / Mihomo only)',
    multiPortBasePort: 'Base port',
    multiPortCount: 'Port count',
    ...
    settingsLockedHint: 'Enter the password to adjust these options. Conversions use default general settings while locked.',
    settingsPassword: 'Access password',
    settingsUnlock: 'Unlock settings',
    settingsUnlocked: 'Unlocked',
    settingsLock: 'Lock again',
    settingsWrongPassword: 'Incorrect password. Please try again.',
    settingsTooManyAttempts: 'Too many attempts. Try again in one minute.',
    settingsRequestFailed: 'Request failed. Check your connection and try again.',
    settingsSessionExpired: 'Your session expired. Enter the password again.',
    settingsLinkOnCopy: 'Click Copy to generate a working link with the current settings.',
    groupByCountry: 'Group by Country',
    groupByCountryTip: 'Clash/Surge/SingBox only',
    includeAutoSelect: 'Include Auto Select Group',
    excludeInvalidNodes: 'Exclude Invalid Nodes',
    excludeInvalidNodesTip: 'Filter out airport info nodes (website/expiry/traffic/plan)',
  ...
  'fa': {
    ...
    settingsLockedHint: 'برای تغییر این گزینه‌ها رمز عبور را وارد کنید. در حالت قفل، تبدیل از تنظیمات عمومی پیش‌فرض استفاده می‌کند.',
    settingsPassword: 'رمز عبور دسترسی',
    settingsUnlock: 'باز کردن تنظیمات',
    settingsUnlocked: 'قفل باز است',
    settingsLock: 'قفل مجدد',
    settingsWrongPassword: 'رمز عبور نادرست است. دوباره تلاش کنید.',
    settingsTooManyAttempts: 'تعداد تلاش‌ها زیاد است. یک دقیقه دیگر تلاش کنید.',
    settingsRequestFailed: 'عملیات ناموفق بود. اتصال خود را بررسی و دوباره تلاش کنید.',
    settingsSessionExpired: 'نشست شما منقضی شده است. رمز عبور را دوباره وارد کنید.',
    settingsLinkOnCopy: 'برای ساخت پیوند با تنظیمات فعلی، روی کپی کلیک کنید.',
    groupByCountry: 'گروه‌بندی بر اساس کشور',
    groupByCountryTip: 'فقط Clash/Surge/SingBox',
    includeAutoSelect: 'شامل گروه انتخاب خودکار',
    excludeInvalidNodes: 'حذف نُدهای نامعتبر',
    excludeInvalidNodesTip: 'فیلتر نُدهای اطلاعاتی (وب‌سایت/انقضا/ترافیک/پلن)',
  ...
  'ru': {
    ...
    settingsLockedHint: 'Введите пароль, чтобы изменить параметры. Пока настройки заблокированы, используются значения по умолчанию.',
    settingsPassword: 'Пароль доступа',
    settingsUnlock: 'Разблокировать',
    settingsUnlocked: 'Разблокировано',
    settingsLock: 'Заблокировать',
    settingsWrongPassword: 'Неверный пароль. Попробуйте ещё раз.',
    settingsTooManyAttempts: 'Слишком много попыток. Повторите через минуту.',
    settingsRequestFailed: 'Ошибка запроса. Проверьте соединение и повторите попытку.',
    settingsSessionExpired: 'Сеанс истёк. Введите пароль ещё раз.',
    settingsLinkOnCopy: 'Нажмите «Копировать», чтобы создать ссылку с текущими настройками.',
    ...
    excludeInvalidNodes: 'Исключить недействительные узлы',
    excludeInvalidNodesTip: 'Фильтр инфо-узлов (сайт/срок/трафик/тариф)',
